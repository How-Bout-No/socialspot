...
useESXIdentity = false	-- Use player names instead of Steam names
useSteamHandle = true	-- Use Steam name as user handle (@...) If false, the player's name will be used instead
--------------------------------------------